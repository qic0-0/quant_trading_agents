...
def plot_single_result(result: Dict, price_df: pd.DataFrame, output_dir: Optional[str] = None, show: bool = True) -> str:
...
def plot_all_results(results: List[Dict], output_dir: str, start_date: str = "2024-01-01", end_date: str = "2024-12-01"):
...
def plot_comparison(results: List[Dict], ticker: str, output_dir: str,
                    start_date: str = "2024-01-01", end_date: str = "2024-12-01"):
